...
# Argparse stuff
parser = argparse.ArgumentParser(description="Interact with Snake Environment")
parser.add_argument('-a', '--agent', type = str, required = True, help = "'H' for human, 'R' for robot")
...
if __name__ == '__main__':
    curses.wrapper(main, args.agent.upper())